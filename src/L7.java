...
public class L7{
    ...
    public static void main(String[] args){
        ...
        System.out.println("You have " + currency.format(12345678));

        DecimalFormat percentage = new DecimalFormat(("00%"));
        System.out.println("Sales tax: " + percentage.format(number));
        System.out.println("Sales tax: " + percentage.format(.07));

        DecimalFormat crazy = new DecimalFormat("This is just lots of money $#,###.00");
        System.out.println(crazy.format(123456789.23456));
