public class L3 {
    ...
    int literalValue = 5;
    int literalValue2 = 6;
    int expressional1 = 5 + 6;
    int expressional2 = literalValue + 6;
    int expressional3 =  literalValue + literalValue2;
    ...
    //bad example
    //int bad Example = 5.4 - 0.4;

    // A String expression is called String Concatenation. You can combine String using the +.
    String expressionExample3 = "A fruit people eat is on " + literalExample3;
